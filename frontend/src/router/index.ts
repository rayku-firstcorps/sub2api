...
router.beforeEach(async (to, _from, next) => {
  ...
  if (
    (to.meta.requiresPayment || to.meta.requiresKeywordFilter || to.meta.requiresRiskControl || to.meta.requiresSubscription) &&
  ...
  if (
    to.meta.requiresKeywordFilter &&
    appStore.publicSettingsLoaded &&
    appStore.cachedPublicSettings?.keyword_filter_enabled === false
  ) {
