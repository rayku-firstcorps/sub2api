  ...
  admin: {
    ...
    settings: {
      ...
      features: {
        ...
        riskControl: {
          title: '风控中心',
          description: '启用内容审计中心入口与网关内容审计入口。默认关闭。',
        ...
        keywordFilter: {
          title: '关键词过滤',
          description: '启用独立关键词过滤页面与网关关键词过滤入口。默认关闭。',
          configureLink: '前往 关键词过滤 配置规则',
          enabled: '启用关键词过滤',
          enabledHint: '关闭后管理员侧边栏入口隐藏，网关关键词过滤不会执行。',
        },
        affiliate: {
          title: '邀请返利',
