export default {
  ...
  admin: {
    ...
    riskControl: {
      title: '风控中心',
      description: '配置网关风控策略并查看关键词过滤与内容审计记录',
      loadFailed: '加载风控中心失败',
      ...
      keyword: {
        openSettings: '关键词过滤设置',
        settingsTitle: '关键词过滤设置',
        enabled: '开启关键词过滤',
        enabledHint: '开启后，非图片生成的用户文本请求会先按关键词和已启用正则规则拦截。',
        enabledShort: '启用',
        records: '关键词命中记录',
        ...
        whitelist: '白名单免杀词',
        whitelistPlaceholder: '每行一个免杀词',
        ruleEditor: '关键词规则',
        ruleEditorHint: '可使用简易多行输入，也可切到高级规则选择匹配模式。',
        simpleRules: '简易',
        advancedRules: '高级',
        keywordRules: '黑名单规则',
        ...
        testInput: '试跑输入',
        testPlaceholder: '输入文本，测试当前已保存的关键词过滤配置',
        test: '试跑',
        testBlocked: '会拦截',
        testPassed: '会放行',
        testRule: '规则',
    ...
    settings: {
      ...
      features: {
        ...
        riskControl: {
          title: '风控中心',
          description: '启用风控中心入口与网关风控入口。默认关闭。',
          configureLink: '前往 风控中心 配置关键词过滤与内容审计',
          enabled: '启用风控中心',
          enabledHint: '关闭后管理员侧边栏入口隐藏，网关关键词过滤和内容审计都不会执行。',
        },
        affiliate: {
          title: '邀请返利',
