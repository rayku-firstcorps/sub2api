export default {
  ...
  admin: {
    ...
    riskControl: {
      title: 'Risk Control',
      description: 'Configure gateway risk controls and review keyword-filter and moderation records',
      ...
      keyword: {
        openSettings: 'Keyword Filter Settings',
        settingsTitle: 'Keyword Filter Settings',
        enabled: 'Enable Keyword Filter',
        enabledHint: 'When enabled, non-image-generation user text requests are blocked first by keywords and enabled regex rules.',
        ...
        whitelistPlaceholder: 'One whitelist term per line',
        ...
        testPlaceholder: 'Enter text to test the currently saved keyword filter config',
        test: 'Test',
    ...
    settings: {
      ...
      features: {
        ...
        riskControl: {
          title: 'Risk Control',
          description: 'Enable the risk control center and gateway risk-control entry point. Disabled by default.',
          configureLink: 'Configure keyword filtering and content moderation in Risk Control',
          enabled: 'Enable Risk Control',
          enabledHint: 'When off, the admin sidebar entry is hidden and gateway keyword filtering and moderation are skipped.',
        },
        affiliate: {
