export default {
  ...
  admin: {
    ...
    riskControl: {
      title: 'Risk Control',
      description: 'Configure content moderation and review moderation records',
      loadFailed: 'Failed to load risk control',
      saveFailed: 'Failed to save content moderation config',
      logsFailed: 'Failed to load risk-control records',
    ...
    settings: {
      ...
      features: {
        ...
        riskControl: {
          title: 'Risk Control',
          description: 'Enable the content moderation center and gateway moderation entry point. Disabled by default.',
          configureLink: 'Configure content moderation in Risk Control',
          enabled: 'Enable Risk Control',
          enabledHint: 'When off, the admin sidebar entry is hidden and gateway content moderation is skipped.',
        },
        keywordFilter: {
          title: 'Keyword Filter',
          description: 'Enable the standalone keyword-filter page and gateway keyword-filter entry point. Disabled by default.',
          configureLink: 'Configure keyword rules in Keyword Filter',
          enabled: 'Enable Keyword Filter',
          enabledHint: 'When off, the admin sidebar entry is hidden and gateway keyword filtering is skipped.',
        },
        affiliate: {
