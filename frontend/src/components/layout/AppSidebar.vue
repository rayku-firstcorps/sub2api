...
const flagKeywordFilter = makeSidebarFlag(FeatureFlags.keywordFilter)
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/keyword-filter', label: t('nav.keywordFilter'), icon: ShieldIcon, hideInSimpleMode: true, featureFlag: flagKeywordFilter },
