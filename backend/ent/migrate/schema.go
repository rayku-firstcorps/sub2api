...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "request_context_json", Type: field.TypeJSON, Nullable: true},
		{Name: "request_context_truncated", Type: field.TypeBool, Default: false},
		{Name: "request_context_bytes", Type: field.TypeInt, Nullable: true},
		{Name: "image_count", Type: field.TypeInt, Default: 0},
